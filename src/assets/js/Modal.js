class Modal {
  constructor(title, message, btnText) {
    ...
    this.title.classList.add("modal__title", "t3", "t3--purple");
    this.line = document.createElement("div");
    this.line.classList.add("modal__line", "section-title__line");
    this.message = document.createElement("span");
    this.message.classList.add("modal__message", "form");
    this.button = document.createElement("button");
    this.button.classList.add("modal__btn", "b2");
